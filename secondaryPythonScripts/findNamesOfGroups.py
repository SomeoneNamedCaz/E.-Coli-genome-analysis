...
def determineGroupIndexes(genomeSeq, PathToFileToLookAt):
    ...
    :param linesOfFileToLookAt: a phylogroupSnpFile of the form of the megacats summary results all that doesn't have the indices corrected
    ...
    with open(PathToFileToLookAt) as file:
        ...
        for line in file:
            ...
            try:
                ...
                raise Exception("""it looks like the megaCATS phylogroupSnpFile does not match the aligned SNP genome phylogroupSnpFile
...
def findNamesOfGroups(metadataPath, genomePath, snpStatPath):
    ...
    try:
        ...
        print(genomePath + " phylogroupSnpFile not found or has fewer than 2 lines")
        exit(1)
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print(
            """please give arguments: combined megaCats phylogroupSnpFile, the phylogroupSnpFile with all the snp genomes, and the metadata phylogroupSnpFile""")
        exit(1)
