...
downloadPath = '/Users/cazcullimore/dev/ericksonLabCode/src/snpalign/DownloadingFromNCBI/AllCommensalStrains/'
...
#                if ID == "":
                ...
                if readyToStart:
                    ...
                    if IDnotDownloaded:
                        t1 = time.time()
                        try:
                            downloadThread = DownloadThread(ID, ID, searchBeginning,downloadPath + ID + ".fasta", "&retType=fasta")
